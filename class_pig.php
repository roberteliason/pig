...
class PIG {
   ...
   */
  public function saveSVG( $filename ) {
      $svg = $this->renderSVG();
...
$ThePIG = New PIG(
  ...
  ['rgba(255,220,190,0.5)', 'rgba(190,255,220,0.5)', 'rgba(220,190,255,0.5)', 'rgba(255,220,250,0.25)', 'rgba(150,255,220,0.25)', 'rgba(220,250,255,0.25)'],
  'rgba(0, 0, 0, 0.5)',
  50, 50, 16, 12
);
